...
if __name__ == '__main__':
    ...
    # Define a test input tensor (batch_size, channels, height, width)
    test_input = torch.randn(1, 3, 48, 48).to(device)  # Example input size matches img_size
